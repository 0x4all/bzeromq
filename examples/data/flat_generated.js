 ...
 * @returns {number}
 */
ReqPoint.prototype.routeid = function() {
 ...
 */
ReqPoint.addRouteid = function(builder, routeid) {
  builder.addFieldInt16(1, routeid, 0);
};
 ...
 * @returns {flatbuffers.Offset}
 */
ReqPoint.createReqPoint = function(builder, _reqid, routeid, x, y) {
  ReqPoint.startReqPoint(builder);
  ReqPoint.add_Reqid(builder, _reqid);
  ReqPoint.addRouteid(builder, routeid);
